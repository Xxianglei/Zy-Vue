...
<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-input v-model="idSearch" clearable placeholder="Id" style="width: 300px;" class="filter-item" />
    ...
    <el-dialog title="增加用户" :visible.sync="dialogFormVisible" width="500px" top="30px">
      ...
      <el-form ref="addForm" :model="addForm" :rules="rules" label-width="100px" class="demo-addForm">
        ...
        <el-form-item label="是否为管理员" prop="superRoot">
          <el-input v-model="addForm.superRoot" />
        </el-form-item>
        <el-form-item>
    ...
    <el-dialog title="修改用户资料" :visible.sync="dialogTableVisible" width="500px" top="30px">
      ...
      <el-form ref="editForm" :model="editForm" :rules="rules" label-width="100px" class="demo-addForm">
        ...
        <el-form-item label="是否为管理员" prop="superRoot">
          <el-input v-model="editForm.superRoot" />
        </el-form-item>
        <el-form-item>
...
<script>
import { findAllUser, findUser, addUser, deleteUser, batchDeleteUser, updateUser } from '@/api/user'
