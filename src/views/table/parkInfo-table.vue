...
<template>
  <div class="app-container">
    ...
    <!-- 编辑的表单 -->
    <el-dialog title="修改车位信息" :visible.sync="dialogTableVisible" width="500px" top="30px">
      <!-- 修改车位信息 -->
      <el-form :model="editForm" :rules="rules" ref="editForm" label-width="100px" class="demo-addForm">
        <el-form-item label="车位长度" prop="width">
          <el-input v-model="editForm.width"></el-input>
        </el-form-item>
        <el-form-item label="车位宽度" prop="length">
